...
PYBIND11_MODULE(cubinterpp_py, m) {
    ...
    py::class_<cip::LinearInterp1D<double>>(m, "LinearInterp1D")
        ...
        .def("eval", &cip::LinearInterp1D<double>::eval<double>, py::return_value_policy::reference_internal)
        .def("evaln", &cip::LinearInterp1D<double>::evaln<DoubleVector>, py::return_value_policy::reference_internal);
    ...
    py::class_<cip::MakimaCubicInterp1D<double>>(m, "MakimaCubicInterp1D")
        ...
        .def("evaln", &cip::MakimaCubicInterp1D<double>::evaln<DoubleVector>, py::return_value_policy::reference_internal);

    py::class_<cip::NaturalCubicInterp1D<double>>(m, "NaturalCubicInterp1D")
        .def(py::init<DoubleVector, DoubleVector>())
        .def("eval", &cip::NaturalCubicInterp1D<double>::eval<double>, py::return_value_policy::reference_internal)
        .def("evaln", &cip::NaturalCubicInterp1D<double>::evaln<DoubleVector>, py::return_value_policy::reference_internal);

    py::class_<cip::NaturalPeriodicCubicInterp1D<double>>(m, "NaturalPeriodicCubicInterp1D")
        .def(py::init<DoubleVector, DoubleVector>())
        .def("eval", &cip::NaturalPeriodicCubicInterp1D<double>::eval<double>, py::return_value_policy::reference_internal)
        .def("evaln", &cip::NaturalPeriodicCubicInterp1D<double>::evaln<DoubleVector>, py::return_value_policy::reference_internal);
