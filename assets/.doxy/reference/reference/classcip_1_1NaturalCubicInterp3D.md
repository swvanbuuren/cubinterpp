...
# Class cip::NaturalCubicInterp3D

**template &lt;typename T, cip::BoundaryConditionType BC, std::size\_t N&gt;**



[**ClassList**](annotated.md) **>** [**cip**](namespacecip.md) **>** [**NaturalCubicInterp3D**](classcip_1_1NaturalCubicInterp3D.md)
...
| Type | Name |
| ---: | :--- |
|   | [**NaturalCubicInterp3D**](#function-naturalcubicinterp3d) (const Vector & \_x, const Vector & \_y, const Vector & \_z, const [**VectorN**](classcip_1_1VectorN.md) & \_f) <br> |
| virtual Vector | [**calc\_slopes**](#function-calc_slopes) (const Vector & x, const Mdspan1D & f) override const<br> |
|   | [**~NaturalCubicInterp3D**](#function-naturalcubicinterp3d) () <br> |
...
### function NaturalCubicInterp3D 

```C++
inline cip::NaturalCubicInterp3D::NaturalCubicInterp3D (
    const Vector & _x,
    const Vector & _y,
    const Vector & _z,
    const VectorN & _f
...
```C++
inline virtual Vector cip::NaturalCubicInterp3D::calc_slopes (
    const Vector & x,
    const Mdspan1D & f
) override const
```
...
------------------------------
The documentation for this class was generated from the following file `include/cubic_interp_3d.hpp`
