...
| class | [**CubicInterp**](classcip_1_1CubicInterp.md) &lt;typename T, typename [**SlopePolicy**](structcip_1_1SlopePolicy.md), N, IM&gt;<br> |
| class | [**CubicInterpND**](classcip_1_1CubicInterpND.md) &lt;typename T, N, IM&gt;<br> |
| class | [**CubicInterpND&lt; T, 1, IM &gt;**](classcip_1_1CubicInterpND_3_01T_00_011_00_01IM_01_4.md) &lt;typename T, IM&gt;<br> |
| class | [**Indexer**](classcip_1_1Indexer.md) &lt;typename T, Method&gt;<br> |
...
| class | [**LinearInterp**](classcip_1_1LinearInterp.md) &lt;typename T, N, IM&gt;<br> |
| class | [**LinearInterpND**](classcip_1_1LinearInterpND.md) &lt;typename T, N, IM&gt;<br> |
| class | [**LinearInterpND&lt; T, 1, IM &gt;**](classcip_1_1LinearInterpND_3_01T_00_011_00_01IM_01_4.md) &lt;typename T, IM&gt;<br> |
| struct | [**SlopePolicy**](structcip_1_1SlopePolicy.md) &lt;Method, BC&gt;<br> |
...
| Type | Name |
| ---: | :--- |
| typedef [**CubicInterp**](classcip_1_1CubicInterp.md)&lt; T, [**SlopePolicy**](structcip_1_1SlopePolicy.md)&lt; SlopeMethod::Akima &gt;, 1, IM &gt; | [**AkimaCubicInterp1D**](#typedef-akimacubicinterp1d)  <br> |
| enum  | [**AkimaWeightMethod**](#enum-akimaweightmethod)  <br> |
| enum  | [**BoundaryConditionType**](#enum-boundaryconditiontype)  <br> |
| enum  | [**IndexMethod**](#enum-indexmethod)  <br> |
| typedef [**LinearInterp**](classcip_1_1LinearInterp.md)&lt; T, 1, IM &gt; | [**LinearInterp1D**](#typedef-linearinterp1d)  <br> |
| typedef [**LinearInterp**](classcip_1_1LinearInterp.md)&lt; T, 2, IM &gt; | [**LinearInterp2D**](#typedef-linearinterp2d)  <br> |
| typedef [**LinearInterp**](classcip_1_1LinearInterp.md)&lt; T, 3, IM &gt; | [**LinearInterp3D**](#typedef-linearinterp3d)  <br> |
| typedef [**LinearInterp**](classcip_1_1LinearInterp.md)&lt; T, 4, IM &gt; | [**LinearInterp4D**](#typedef-linearinterp4d)  <br> |
| typedef [**CubicInterp**](classcip_1_1CubicInterp.md)&lt; T, [**SlopePolicy**](structcip_1_1SlopePolicy.md)&lt; SlopeMethod::Makima &gt;, 1, IM &gt; | [**MakimaCubicInterp1D**](#typedef-makimacubicinterp1d)  <br> |
| typedef [**CubicInterp**](classcip_1_1CubicInterp.md)&lt; T, [**SlopePolicy**](structcip_1_1SlopePolicy.md)&lt; SlopeMethod::Makima &gt;, N, IM &gt; | [**MakimaCubicInterp2D**](#typedef-makimacubicinterp2d)  <br> |
| typedef [**CubicInterp**](classcip_1_1CubicInterp.md)&lt; T, [**SlopePolicy**](structcip_1_1SlopePolicy.md)&lt; SlopeMethod::Monotonic &gt;, 1, IM &gt; | [**MonotonicCubicInterp1D**](#typedef-monotoniccubicinterp1d)  <br> |
| typedef [**CubicInterp**](classcip_1_1CubicInterp.md)&lt; T, [**SlopePolicy**](structcip_1_1SlopePolicy.md)&lt; SlopeMethod::Monotonic &gt;, N, IM &gt; | [**MonotonicCubicInterp2D**](#typedef-monotoniccubicinterp2d)  <br> |
| typedef [**CubicInterp**](classcip_1_1CubicInterp.md)&lt; T, [**SlopePolicy**](structcip_1_1SlopePolicy.md)&lt; SlopeMethod::Natural, BC &gt;, 1, IM &gt; | [**NaturalCubicInterp1D**](#typedef-naturalcubicinterp1d)  <br> |
| typedef [**CubicInterp**](classcip_1_1CubicInterp.md)&lt; T, [**SlopePolicy**](structcip_1_1SlopePolicy.md)&lt; SlopeMethod::Natural, BC &gt;, N, IM &gt; | [**NaturalCubicInterp2D**](#typedef-naturalcubicinterp2d)  <br> |
| typedef [**CubicInterp**](classcip_1_1CubicInterp.md)&lt; T, [**SlopePolicy**](structcip_1_1SlopePolicy.md)&lt; SlopeMethod::Natural, BC &gt;, N, IM &gt; | [**NaturalCubicInterp3D**](#typedef-naturalcubicinterp3d)  <br> |
| typedef [**CubicInterp**](classcip_1_1CubicInterp.md)&lt; T, [**SlopePolicy**](structcip_1_1SlopePolicy.md)&lt; SlopeMethod::Natural, BC &gt;, 1, IM &gt; | [**NaturalPeriodicCubicInterp1D**](#typedef-naturalperiodiccubicinterp1d)  <br> |
| typedef [**CubicInterp**](classcip_1_1CubicInterp.md)&lt; T, [**SlopePolicy**](structcip_1_1SlopePolicy.md)&lt; SlopeMethod::Natural, BC &gt;, N, IM &gt; | [**NaturalPeriodicCubicInterp2D**](#typedef-naturalperiodiccubicinterp2d)  <br> |
| enum  | [**SlopeMethod**](#enum-slopemethod)  <br> |
...
### typedef AkimaCubicInterp1D 

```C++
using cip::AkimaCubicInterp1D = typedef CubicInterp<T, SlopePolicy<SlopeMethod::Akima>, 1, IM>;
```
...
### enum AkimaWeightMethod 

```C++
enum cip::AkimaWeightMethod {
    Standard,
    Modified
};
```
...
```C++
template<typename T, AkimaWeightMethod WeightMethod, typename Tx, typename Tf>
