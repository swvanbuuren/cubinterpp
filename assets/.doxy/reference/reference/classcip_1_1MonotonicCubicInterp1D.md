...
# Class cip::MonotonicCubicInterp1D

**template &lt;typename T, std::size\_t N&gt;**



[**ClassList**](annotated.md) **>** [**cip**](namespacecip.md) **>** [**MonotonicCubicInterp1D**](classcip_1_1MonotonicCubicInterp1D.md)
...
| Type | Name |
| ---: | :--- |
|   | [**MonotonicCubicInterp1D**](#function-monotoniccubicinterp1d) (const Vector & x, const Vector & f) <br> |
|  Vector | [**calc\_slopes**](#function-calc_slopes) (const Vector & x, const Vector & f) override const<br> |
|   | [**~MonotonicCubicInterp1D**](#function-monotoniccubicinterp1d) () <br> |
...
### function MonotonicCubicInterp1D 

```C++
inline cip::MonotonicCubicInterp1D::MonotonicCubicInterp1D (
    const Vector & x,
    const Vector & f
) 
```
...
```C++
inline Vector cip::MonotonicCubicInterp1D::calc_slopes (
    const Vector & x,
    const Vector & f
) override const
```
